...
twitch_miner = TwitchChannelPointsMiner(
    ...
    streamer_settings=StreamerSettings(
        ...
        bet=BetSettings(
            ...
            percentage=70,                       # Place the x% of your channel points
...
twitch_miner.mine(
    [
        Streamer("tarik", settings=StreamerSettings(make_predictions=True  , follow_raid=False , claim_drops=True  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=70 , stealth_mode=True,  percentage_gap=20 , max_points=50000   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_USERS,      where=Condition.LTE, value=800 ) ) )),
        Streamer("valorant", settings=StreamerSettings(make_predictions=True  , follow_raid=False , claim_drops=True  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=70 , stealth_mode=True,  percentage_gap=20 , max_points=50000   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_USERS,      where=Condition.LTE, value=800 ) ) )),
        Streamer("ohnepixel", settings=StreamerSettings(make_predictions=True , follow_raid=True  , claim_drops=False ,                     bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=70 , stealth_mode=False, percentage_gap=20 , max_points=50000  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
        Streamer("subroza", settings=StreamerSettings(make_predictions=True  , follow_raid=False ,                     watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=70, stealth_mode=False, percentage_gap=30 , max_points=50000 , filter_condition=FilterCondition(by=OutcomeKeys.ODDS,             where=Condition.LT,  value=300 ) ) ))
